...
export interface ICreditScoreOracleInterface extends Interface {
...
export interface ICreditScoreOracle extends BaseContract {
  connect(runner?: ContractRunner | null): ICreditScoreOracle;
  waitForDeployment(): Promise<this>;

  interface: ICreditScoreOracleInterface;
